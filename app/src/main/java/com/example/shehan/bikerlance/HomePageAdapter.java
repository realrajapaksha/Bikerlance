...
public class HomePageAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (homePageModelList.get(position).getType()) {
            ...
            case HomePageModel.HORIZONTAL_PRODUCT_VIEW:
                ...
                ((HorizontalProductViewholder) viewHolder).setHorizontalProdcutLayout(horizontalProductScrollModelList, horizontalLayouttitle, layoutcolor, viewAllProductList);
                break;
            case HomePageModel.GRID_PRODUCT_VIEW:
    ...
    public class BannerSliderViewholder extends RecyclerView.ViewHolder {
        ...
        private Timer timer;
        final private long DELAY_TIME = 2500;
        final private long PERIOD_TIME = 2500;
    ...
    public class StripAdBannerViewholder extends RecyclerView.ViewHolder {
        ...
        private void setStripAd(String resource, String color) {
            Glide.with(itemView.getContext()).load(resource).apply(new RequestOptions().placeholder(R.mipmap.icon_placeholder)).into(stripAdImage);
    ...
    public class HorizontalProductViewholder extends RecyclerView.ViewHolder {
        ...
        private void setHorizontalProdcutLayout(List<HorizontalProductScrollModel> horizontalProductScrollModelList, final String title, String color, final List<WishlistModel> viewAllProductList) {
    ...
    public class GridproductViewholder extends RecyclerView.ViewHolder {
        ...
        public GridproductViewholder(@NonNull View itemView) {
            super(itemView);
            container = itemView.findViewById(R.id.container);
            gridLayoutTitle = itemView.findViewById(R.id.grid_product_layout_tittle);
        ...
        private void setGridProductLayout(final List<HorizontalProductScrollModel> horizontalProductScrollModelList, final String title, String color) {
            ...
            for (int x = 0; x < 4; x++) {
                ...
                TextView productTitle = gridProductLayout.getChildAt(x).findViewById(R.id.h__s_product_title);
